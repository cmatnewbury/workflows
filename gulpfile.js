...
gulp.task('watch', function(){
    ...
    gulp.watch(htmlSources, gulp.parallel('html'));
    gulp.watch(jsonSources, gulp.parallel('json'));
...
gulp.task('default',  gulp.parallel('coffee','js','compass', 'watch', 'connect', 'html', 'json'));
